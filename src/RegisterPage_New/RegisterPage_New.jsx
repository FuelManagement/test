...
class RegisterPage_New extends React.Component {
    constructor(props) {
        super(props);
...
const connectedRegisterPage = connect(mapStateToProps)(RegisterPage_New);
export { connectedRegisterPage as RegisterPage_New };
