    ...
    render() {
        return (
            <div className="col-md-8 offset-md-3 contentDiv">
                <h3 className="vendor-text" className="table-main-heading"> Sales Orders</h3>
                <hr />
                <div>
                    <Link to="/rfq/add" className="addRFQ-link">
                        <button className="btn btn-outline btn-success">
                            <FontAwesomeIcon icon="plus" /> Sales Order
                    </button>
                    </Link>
...
const connectedRfq = connect(mapStateToProps)(SalesOrder);
export { connectedRfq as SalesOrder }; 